...
private val logger = Logger.withTag("SystemPath")
        ...
        object : SimpleFileVisitor<NioPath>() {
            ...
            override fun postVisitDirectory(dir: NioPath, exc: IOException?): FileVisitResult {
                ...
                try {
                    ...
                    logger.w(e) { "Failed to delete directory $dir. Just ignoring." }
                }
...
//    prefix: String,
//): SystemPath = createTempDirectory(prefix = prefix).toKtPath().inSystem
//
//actual fun SystemPaths.createTempFile(
//    prefix: String,
//    suffix: String
//): SystemPath = createTempFile(prefix = prefix, suffix = suffix).toKtPath().inSystem
